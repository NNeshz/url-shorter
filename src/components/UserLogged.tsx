...
const UserLogged = () => {
  return (
    <div className="flex flex-col items-center gap-y-2 text-white backdrop-filter backdrop-blur-sm bg-opacity-10 border border-white/10 px-4 md:px-0 py-8 rounded-md">
